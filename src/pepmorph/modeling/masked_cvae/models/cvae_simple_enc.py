...
class CVAESimpleEnc(nn.Module):
    """
    Masked conditional CVAE with Transformer encoder/decoder.

    Defaults mirror the paper settings: 2-layer encoder/decoder, 256 hidden dim,
    8 attention heads, and a 24-dim latent space.
    """
    def __init__(self, vocab_size,
                 latent_dim=24, cond_dim=6, cond_summary_dim=64,
                 max_seq_length=50, 
