...
# Condition vector order: [length, is_assembled, ap, has_beta_sheet_content, hydrophobic_moment, net_charge].
# Binary indices map to is_assembled and has_beta_sheet_content; others are continuous.
IDX_BIN = [1, 3]
IDX_CONT = [0, 2, 4, 5]
