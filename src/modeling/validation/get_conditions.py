...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--fibers-init", type=str, default="generated_fibers_init.txt")
    parser.add_argument("--spheres-init", type=str, default="generated_spheres_init.txt")
    parser.add_argument("--output-fibers", type=str, default="fibers_with_conditions.csv")
    parser.add_argument("--output-spheres", type=str, default="spheres_with_conditions.csv")
